    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/candidate/admin/cms/candidates/new')}
                ...
                <tr key={candidate._id} className="odd:bg-white even:bg-slate-50 hover:bg-sky-50/40">
                  ...
                  <td className="px-5 py-3">
                    <div className="flex gap-2">
                      <button
                        type="button"
                        onClick={() => navigate(`/candidate/admin/cms/candidates/${candidate._id}`)}
                      ...
                      <button
                        type="button"
                        onClick={() => navigate(`/candidate/admin/cms/candidates/${candidate._id}/edit`)}
