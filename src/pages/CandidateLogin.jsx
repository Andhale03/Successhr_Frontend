        ...
        <div className="flex flex-col justify-between border-b border-sky-100 bg-white px-6 py-8 sm:px-10 lg:border-b-0 lg:border-r">
          <div>
            ...
            <div className="mt-8 max-w-lg">
              <p className="text-sm font-bold uppercase text-sky-700">Candidate management workspace</p>
              <h1 className="mt-3 text-3xl font-bold text-slate-950 sm:text-4xl">Candidate Admin Login</h1>
              <p className="mt-3 text-base text-slate-600">
                Manage candidates, companies, and process panel from the dedicated Candidate Management portal.
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 px-6 py-8 sm:px-10 lg:py-12">
          <div>
            <div className="mb-4 flex items-center gap-3 lg:hidden">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-sky-700">Candidate admin login</p>
              </div>
            </div>
          ...
          <label className="block text-sm font-semibold text-slate-700">
            ...
            <input
              ...
              placeholder="candidate-admin@consultancy.com"
            />
